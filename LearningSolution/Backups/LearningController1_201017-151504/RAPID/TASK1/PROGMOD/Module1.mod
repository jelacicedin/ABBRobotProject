MODULE Module1
    ...
    PERS tooldata small_suction_gripper:=[TRUE,[[0,0,121.436],[1,0,0,0]],[1,[0.443,-9.457,69.909],[1,0,0,0],0,0,0]];
    !***********************************************************
    !
    ! Module:  Module1
    !
    ...
    ENDPROC
    PROC Path_10_2()
        !robtarget searchPoint;
        !SearchL detected_edge, sp, p10, v100, small_suction_gripper\WObj:=wobj0;
